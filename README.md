...
![Poetry](https://img.shields.io/badge/Poetry-1.8.1-purple) ![Python](https://img.shields.io/badge/Python-3.12%20(default)%20%7C%203.11%20%7C%203.10%20%7C%203.9%20%7C%203.8-blue) ![Variants](https://img.shields.io/badge/Variants-Bookworm%20(default)%20%7C%20Slim-orange
)
...
- Poetry 1.8.1: `ghcr.io/withlogicco/poetry:1.8.1`
- Poetry 1.8.1 on Python 3.12: `ghcr.io/withlogicco/poetry:1.8.1-python-3.12`
- Poetry 1.8.1 on Bookworm: `ghcr.io/withlogicco/poetry:1.8.1-bookworm`
- Poetry 1.8.1 on Python 3.12 and Bookworm: `ghcr.io/withlogicco/poetry:1.8.1-python-3.12-bookworm`
...
```dockerfile
FROM ghcr.io/withlogicco/poetry:1.8.1
